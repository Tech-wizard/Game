var AbstractPage = (function (_super) {
    ...
    var d = __define,c=AbstractPage,p=c.prototype;
    p.onEnter = function () {
    };
    p.onExit = function () {
    };
...
egret.registerClass(AbstractPage,'AbstractPage',["State"]);
var PageContainer = (function (_super) {
    ...
    var d = __define,c=PageContainer,p=c.prototype;
    p.addListener = function () {
        var _this = this;
        this.addEventListener(egret.TouchEvent.TOUCH_BEGIN, function (e) {
            _this._touchBeginLocationY = e.stageY;
            _this.addEventListener(egret.TouchEvent.TOUCH_MOVE, _this.onTouchMoveHandler, _this);
        }, this);
        this.addEventListener(egret.TouchEvent.TOUCH_END, function (e) {
            _this.removeEventListener(egret.TouchEvent.TOUCH_MOVE, _this.onTouchMoveHandler, _this);
            _this.onTouchEndHandler(e);
        }, this);
    };
    p.onTouchEndHandler = function (e) {
        var _this = this;
        ...
        if (this._touchDistance <= -PageContainer.HEIGHT / 2 && nextPage) {
            egret.Tween.get(currentPage).to({ y: -PageContainer.HEIGHT }, 300).call(function () {
                _this.updatePagePosition();
                _this.changePage("next");
                _this.updatePageDepth();
            ...
            egret.Tween.get(currentPage).to({ y: 0 }, 300).call(function () {
                _this.updatePagePosition();
            }, this).addEventListener("change", function () {
                _this.updatePagePosition();
            }, this);
    ...
    PageContainer.HEIGHT = 1136;
    return PageContainer;
}(egret.DisplayObjectContainer));
egret.registerClass(PageContainer,'PageContainer');
...
var ThirdPage = (function (_super) {
    ...
    var d = __define,c=ThirdPage,p=c.prototype;
    p.onEnter = function () {
        this.back.text = "返回";
        this.back.size = 30;
...
egret.registerClass(ThirdPage,'ThirdPage');
